...
| Integer   | Intero / _Integer_ | Usato sia tradotto che originale quando necessario. |
| Float     | Float | Numero in virgola mobile, usato il termine originale per brevità. |
| Boolean   | Booleano | |
| Struct    | _Struct_ | |
| Enum      | _Enum_ | Usato termine originale per brevità rispetto a enumerazione. |
| Tuple     | Tupla / Tuple | |
...
| --------- | -------- | -------- |
| Ownership | _Ownership_ | Possesso / Proprietà di una variabile sui dati che contiene. |
