...
Per ulteriori dettagli, la [_Guida alle
edizioni_](https://doc.rust-lang.org/stable/edition-guide/) è un libro completo
sulle edizioni che elenca le differenze tra le edizioni e spiega come aggiornare
automaticamente il vostro codice a una nuova edizione tramite `cargo fix`.
