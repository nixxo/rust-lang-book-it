## Mettere Tutto Insieme: _Future_, _Task_ e _Thread_
...
esplicitamente in questo capitolo, ma che è stato implicato dal fatto che ogni
volta che abbiamo terminato una _future_, il suo stato è stato pulito
correttamente.
...
`spawn_blocking` e `spawn_task`, è multi-thread per impostazione predefinita!
...
Questo approccio richiede effettivamente sia _thread_ _che_ _task_, e quindi
_future_.
