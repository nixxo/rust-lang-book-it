...
enumerando le sue possibili _varianti_. Per prima cosa definiremo e useremo
un'_enum_ per mostrare come un'_enum_ possa codificare un significato insieme ai
